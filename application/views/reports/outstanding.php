...
<input type="hidden" id="supplier_total_gold_fine1">
<input type="hidden" id="supplier_total_silver_fine1">
<input type="hidden" id="supplier_total_amount1">
<input type="hidden" id="supplier_total_net_amount1">
<input type="hidden" id="customer_total_gold_fine1">
<input type="hidden" id="customer_total_silver_fine1">
<input type="hidden" id="customer_total_amount1">
<input type="hidden" id="customer_total_net_amount1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"
                    style="margin-right: 15px;">Close</button>
            </div>
        </div>
    </div>
</div>
        ...
        table = $('#outstanding_table').DataTable({
            ...
            "ajax": {
                ...
                "dataSrc": function (jsondata) {
                    ...
                    if (jsondata.supplier_total_silver_fine) {
                        $('#supplier_total_silver_fine1').val(jsondata.supplier_total_silver_fine);
                    } else {
                        $('#supplier_total_silver_fine1').val('');
                    }
                    if (jsondata.supplier_total_amount) {
                        $('#supplier_total_amount1').val(jsondata.supplier_total_amount);
                    } else {
                        $('#supplier_total_amount1').val('');
                    }
                    if (jsondata.supplier_total_net_amount) {
                        $('#supplier_total_net_amount1').val(jsondata.supplier_total_net_amount);
                    } else {
                    ...
                    if (jsondata.customer_total_silver_fine) {
                        $('#customer_total_silver_fine1').val(jsondata.customer_total_silver_fine);
                    } else {
                        $('#customer_total_silver_fine1').val('');
                    }
                    if (jsondata.customer_total_amount) {
                        $('#customer_total_amount1').val(jsondata.customer_total_amount);
                    } else {
                        $('#customer_total_amount1').val('');
                    }
                    if (jsondata.customer_total_net_amount) {
                        $('#customer_total_net_amount1').val(jsondata.customer_total_net_amount);
                    } else {
