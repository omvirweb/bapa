                                ...
                                <div class="row">
                                    ...
                                    <div class="line_item_form item_fields_div">
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <input type="text" name="line_items_data[add_n]" class="form-control add_n num_only" id="add_n" placeholder="" value="">
                                        </div>
                                        <div class="col-md-1">
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <input type="text" name="line_items_data[wastage]" class="form-control num_only" id="wastage"  placeholder="" value="0"><br />
                                        </div>
                                        <div class="col-md-1">
                                        ...
                                        <table style="" class="table custom-table item-table">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th class="text-right" id="total_receive_add_n"></th>
                                        ...
                                        <table style="" class="table custom-table item-table">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th class="text-right" id="total_issue_add_n"></th>
...
//                            alert();
        ...
        $(document).on('keyup change', '#weight, #less, #add_n', function () {
        var weight = parseFloat($('#weight').val()) || 0;
        weight = round(weight, 2).toFixed(3);
        var less = parseFloat($('#less').val()) || 0;
        less = round(less, 2).toFixed(3);
        var add_n = parseFloat($('#add_n').val()) || 0;
        add_n = round(add_n, 2).toFixed(3);
        var net_wt = 0;
        net_wt = parseFloat(weight) - parseFloat(less) + parseFloat(add_n);
...
//                    '<td class="text-right"><input type="text" name="pts_wstg[]" id="pts_wstg_' + index + '" data-pts_selected_index="' + index + '" class="pts_wstg num_only" value="'+ value.wstg + '" style="width:100px;"></td>' +
    ...
    function display_lineitem_html(lineitem_objectdata) {
        ...
        $.each(lineitem_objectdata, function (index, value) {
            ...
            var add_n = parseFloat(value.add_n) || 0; // Get the add_n value
            ...
            var row_html = '<tr class="lineitem_index_' + index + '"><td class="">' +
                    ...
                    '<td class="text-right">' + add_n.toFixed(3) + '</td>' +  // Add the new column for add_n
            ...
            if(value.type_id == '<?php echo MANUFACTURE_TYPE_RECEIVE_ID; ?>'){
                ...
                total_receive_add_n = parseFloat(total_receive_add_n) + parseFloat(add_n);
                ...
                total_issue_add_n = parseFloat(total_issue_add_n) + parseFloat(add_n);
        ...
        $('#total_issue_add_n').html(total_issue_add_n.toFixed(3));
        ...
        $('#total_receive_add_n').html(total_receive_add_n.toFixed(3));
    ...
    function edit_lineitem(index) {
        ...
        $("#less").val(value.less);
        $("#add_n").val(value.add_n);  // Set the Add field value
