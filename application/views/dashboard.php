		...
		<div class="row">
			...
			<div class="col-lg-3 col-xs-6">
				...
				<div class="small-box bg-green">
					<div class="inner">
						<h3><?php echo $total_lot_items;?></h3>
						<p>Lot Items</p>
					</div>
					<div class="icon">
            ...
            <div class="col-lg-3 col-xs-12">
                ...
                <div class="small-box bg-blue">
                    <div class="inner">
                        <h3 style="float: left; width: 25%;" id="pending_orders"><?php echo $pending_orders; ?></h3>
                        <div class="col-xs-6">
                            <input type="text" name="date" id="datepicker1" class="from_date form-control" value="">
                        </div>
                        <div class="clearfix"></div>
                        <p>Pending Lot Items</p>
                    </div>
                    <div class="icon">
                        <i class="ion ion-stats-bars"></i>
                    </div>
                    <a href="#" class="small-box-footer" id="pending_oredr_click">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
			<!-- ./col -->
