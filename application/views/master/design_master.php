                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <form class="form-horizontal" id="design_form"  action="<?= base_url('master/save_lot_master') ?>" method="post" novalidate enctype="multipart/form-data">                                    
                                            ...
                                            <label for="die_no" style="margin-top: 10px;">Weight for BOM</label>
                                            <input type="text" name="weight_for_bom" id="weight_for_bom" class="form-control" value="<?= (isset($design_data->weight_for_bom)) ? $design_data->weight_for_bom : ''; ?>"><br />
                                            <div class="clrearfix"></div>
