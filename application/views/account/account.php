                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="account_status" id="account_status" class="form-control select2">
                                                <option value="0" <?= (isset($account_status) && $account_status == 0) ? 'selected' : '' ?>>Not Defined</option>
                                                <option value="1" <?= (isset($account_status) && $account_status == 1) ? 'selected' : '' ?>>Green</option>
                                                <option value="2" <?= (isset($account_status) && $account_status == 2) ? 'selected' : '' ?>>Yellow</option>
                                                <option value="3" <?= (isset($account_status) && $account_status == 3) ? 'selected' : '' ?>>Red</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
