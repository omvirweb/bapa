                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="box-body table-responsive">
                                        ...
                                        <div class="col-md-2">
                                            <label for="delivery_from_date">Delivery From Date</label>
                                            <input type="text" name="delivery_from_date" id="delivery_from_date" class="form-control " value="<?=date("01-m-Y")?>">
                                            <label style="font-size: 10px">Everything From Start <input type="checkbox" name="everything_delivery_from_start" id="everything_delivery_from_start" checked="true" ></label>
                                        </div>
                                        <div class="col-md-2">
                                            <label for="delivery_to_date">Delivery To Date</label>
                                            <input type="text" name="delivery_to_date" id="delivery_to_date" class="form-control " value="<?=date("d-m-Y")?>">
                                        </div>
                                        <div class="col-md-3">
...
//        initAjaxSelect2($("#item_id"), "<?= base_url('app/item_name_select2_source') ?>");
        ...
        table = $('#lot_master_table').DataTable({
            ...
            buttons: [{
                extend: 'pdfHtml5',
                download: 'open',
                text: 'Print Delivery Report',
                pageSize: 'A4',
                title: function () { return ('Order List') },
...
//            "paging": false,
            ...
            "ajax": {
                "url": "<?php echo site_url('new_order/new_order_datatable_2') ?>",
                "type": "POST",
                "data": function (d) {
                    ...
                    d.delivery_from_date = $('#delivery_from_date').val();
                    d.delivery_to_date = $('#delivery_to_date').val();
                    d.supplier_id = $('#order_supplier_id').val();
                    d.everything_from_start = $('input[name="everything_from_start"]').prop('checked');
                    d.everything_delivery_from_start = $('input[name="everything_delivery_from_start"]').prop('checked');
                },
                "complete": function () {
                    $('#ajax-loader').hide();
                },
        ...
        $(document).on('change', '#everything_delivery_from_start', function(){
            $('#ajax-loader').show();
            table.draw();
        });
