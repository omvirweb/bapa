...
//            console.log(pts_grwt + ' ' + pe_stock_grwt);
            ...
            pts_lineitem_objectdata[pts_selected_index].net_wt = round(pts_lineitem_objectdata[pts_selected_index].net_wt, 3).toFixed(3);
            ...
            pts_lineitem_objectdata[pts_selected_index].fine = round(pts_lineitem_objectdata[pts_selected_index].fine, 3).toFixed(3);
        ...
        $(document).on('keyup change', '#grwt, #less', function () {
            ...
            net_wt = round(net_wt, 3).toFixed(3);
...
//            });
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(lineitem['group_name'] == '<?php echo CATEGORY_GROUP_GOLD_ID; ?>'){
                        lineitem['metal_grwt'] = round(lineitem['metal_grwt'], 3).toFixed(3);
                        var metal_fine = lineitem['metal_fine'] = round(lineitem['metal_fine'], 3).toFixed(3);
                    } else {
        ...
        $(document).on('keyup change', '#gold_weight, #gold_rate', function () {
            ...
            gold_weight = round(gold_weight, 3).toFixed(3);
            var gold_rate = parseFloat($('#gold_rate').val()) || 0;
            gold_rate = round(gold_rate, 3).toFixed(3);
            var value = 0;
        ...
        $(document).on('click', '#transfer_button', function () {
            ...
            var transfer_gold = lineitem['transfer_gold'] = round(lineitem['transfer_gold'], 3).toFixed(3);
            var transfer_silver = lineitem['transfer_silver'] = round(lineitem['transfer_silver'], 3).toFixed(3);
        ...
        $(document).on('click', '#order_to_sell_button', function () {
            ...
            $.each($("input.selected_index:checked"), function() {
                ...
                ots_lineitem_objectdata[selected_index].fine = round(parseFloat(ots_lineitem_objectdata[selected_index].net_wt) * (parseFloat(ots_lineitem_objectdata[selected_index].touch_id) + parseFloat(ots_lineitem_objectdata[selected_index].wstg)) / 100,3).toFixed(3);
...
//            });
    ...
    function display_pts_lineitem_html(pts_lineitem_objectdata){
        ...
        $('#pts_total_fine').html(round(pts_total_fine, 3).toFixed(3));
        checked_average_value();
    }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(json.account_status == "1"){
                        $('.bk_account_color').css('background-color',"#00a65a");
                    }else if(json.account_status == "2"){
                        $('.bk_account_color').css('background-color',"#f39c12");
                    }else if(json.account_status == "3"){
                        $('.bk_account_color').css('background-color',"#dd4b39");
                    }else if(json.account_status == "0"){
                        $('.bk_account_color').css('background-color',"#00c0ef");
                    }
                }
            });
        }
...
//                amount = zero_value - parseFloat(amount);
        ...
        $('#total_rfid_wt').html(round(total_rfid_wt, 3).toFixed(3));
        $('#total_loose_pcs').html(total_loose_pcs);
        $('#total_loose_wt').html(round(total_loose_wt, 3).toFixed(3));
        $('#ajax-loader').hide();
    }
...
//        console.log(metal_objectdata);
        $.each(metal_objectdata, function (index, value) {
            ...
            if(value.group_name == '<?php echo CATEGORY_GROUP_GOLD_ID; ?>'){
                ...
                var gold_value = round(parseFloat(metal_fine), 3).toFixed(3);
                var silver_value = '';
            } else {
...
//        console.log(value.adjust_cr_id);
    ...
    function checked_average_value() {
        ...
        $('#pts_checked_total_fine').html(round(pts_checked_total_fine, 3).toFixed(3));
    }
