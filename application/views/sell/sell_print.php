...
<body>
    <?php if (isset($isimage)) { ?>
        ...
        <table class="border">
            <tr>
                <td colspan="3" align="center"><strong>Estimate</strong></td>
            </tr>
            <tr>
                <td><?php echo $sell_data->account_name; ?></td>
                <td>Date :
                    <?php echo !empty($sell_data->sell_date) ? date('d-M-Y', strtotime($sell_data->sell_date)) : ''; ?>
                </td>
                <td>Voucher No. : <?php echo $sell_data->sell_no; ?></td>
            </tr>
            <tr>
                <?php if ($remark_2 == '1') { ?>
                    <td colspan="3">Remark : <?php echo $sell_data->sell_remark; ?></td>
                <?php } ?>
            </tr>
        </table>
        <table class="border">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if ($line_item_remark == '1' && $display_line_item_remark_in_print == '1') { ?>
                                <?php if (isset($sell_item_row->li_narration) && !empty($sell_item_row->li_narration)) {
                                    echo '<small> - ' . $sell_item_row->li_narration . '</small>';
                                } ?>
                            <?php } ?>
                        </td>
                        ...
                        <?php if ($sell_purchase_print_display_gold_fine_column == '1') { ?>
                            <td class="text-right">
                                <?php echo ($sell_item_row->group_name == CATEGORY_GROUP_GOLD_ID) ? $gold_fine : ''; ?>
                            </td>
                        <?php } ?>
                        <!-- <td class="text-right">
                            <?php echo ($sell_item_row->group_name == CATEGORY_GROUP_SILVER_ID) ? $silver_fine : ''; ?>
                        </td> -->
            ...
            if (!empty($ad_charges_data)) {
                foreach ($ad_charges_data as $ad_charges_data_row) {
                    ...
                    <tr>
                        <td><?php echo $row_inc; ?></td>
                        <td><?php echo 'Charges - ' . $ad_charges_data_row->ad_name . ' - ' . $ad_charges_data_row->ad_pcs . ' @ ' . $ad_charges_data_row->ad_rate; ?>
                        </td>
                        <td></td>
                        <?php if ($less_netwt_2 == '1') { ?>
                            <td></td>
            ...
            if (!empty($pay_rec_data)) {
                foreach ($pay_rec_data as $pay_rec_data_row) {
                    ...
                    <tr>
                        <td><?php echo $row_inc; ?></td>
                        <td><?php echo $pay_rec_data_row->payment_receipt_name . ' - ' . $pay_rec_data_row->cash_cheque . $pay_rec_data_row->bank_name . ' - ' . $pay_rec_data_row->narration; ?>
                        </td>
                        <td></td>
                        <?php if ($less_netwt_2 == '1') { ?>
                            <td></td>
            ...
            if (!empty($metal_data)) {
                foreach ($metal_data as $metal_data_row) {
                    ...
                    <tr>
                        <td><?php echo $row_inc; ?></td>
                        <td><?php echo $metal_data_row->metal_payment_receipt_name . ' - ' . $metal_data_row->metal_item_name . ' - ' . $metal_data_row->metal_narration; ?>
                        </td>
                        ...
                        <?php if ($sell_purchase_print_display_gold_fine_column == '1') { ?>
                            <td class="text-right">
                                <?php echo ($metal_data_row->group_name == CATEGORY_GROUP_GOLD_ID) ? $gold_fine : ''; ?>
                            </td>
                        <?php } ?>
                        <!-- <td class="text-right">
                            <?php echo ($metal_data_row->group_name == CATEGORY_GROUP_SILVER_ID) ? $silver_fine : ''; ?>
                        </td> -->
                        <td></td>
                    </tr>
                    <?php
            ...
            if (!empty($gold_data)) {
                foreach ($gold_data as $gold_data_row) {
                    ...
                    <tr>
                        <td><?php echo $row_inc; ?></td>
                        <td><?php echo 'Gold Bhav - ' . $gold_data_row->gold_sale_purchase_name . ' @ ' . $gold_data_row->gold_rate . ' - ' . $gold_data_row->gold_narration; ?>
                        </td>
                        <td></td>
                        <?php if ($less_netwt_2 == '1') { ?>
                            <td></td>
            ...
            if (!empty($silver_data)) {
                foreach ($silver_data as $silver_data_row) {
                    ...
                    <tr>
                        <td><?php echo $row_inc; ?></td>
                        <td><?php echo 'Silver Bhav - ' . $silver_data_row->silver_sale_purchase_name . ' @ ' . $silver_data_row->silver_rate . ' - ' . $silver_data_row->silver_narration; ?>
                        </td>
                        <td></td>
                        <?php if ($less_netwt_2 == '1') { ?>
                            <td></td>
            ...
            if (!empty($transfer_data)) {
                foreach ($transfer_data as $transfer_data_row) {
                    ...
                    <tr>
                        <td><?php echo $row_inc; ?></td>
                        <td><?php echo 'Transfer - ' . $transfer_data_row->naam_jama_name . ' - ' . $transfer_data_row->party_name . ' - ' . $transfer_data_row->transfer_narration; ?>
                        </td>
                        <td></td>
                        <?php if ($less_netwt_2 == '1') { ?>
                            <td></td>
            ...
            <?php } ?>
            <tr>
                <td class="text-right" colspan="7" style="width:47px;"><b>Bill Bal.</b></td>
            ...
            <tr>
                <td class="text-right" colspan="7" style="width:50px;"><b>Net Bal.</b></td>
                <td class="text-right">
                    <?php echo number_format(($sell_data->old_gold_fine + $total_gold_fine), 3, '.', ''); ?>
                </td>
                <!-- <td class="text-right">
                    <?php echo number_format(($sell_data->old_silver_fine + $total_silver_fine), 3, '.', ''); ?>
                </td> -->
                <td class="text-right">
                    <?php echo number_format(($sell_data->old_amount + $total_amount), 2, '.', ''); ?>
                </td>
            </tr>
        </table>
