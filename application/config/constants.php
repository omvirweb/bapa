...
// SMS
define("SEND_ORDER_CREATE_SMS", 'Dear {{party_name}} Your Order Has Been Created With Order No : {{order_no}} Total Weight  : {{total_weight}} Total Pcs : {{total_pcs}} Delivery Date : {{delvery_date}}.');
...
define('PRO_MODULE_HALLMARK', 'yes');
define('PRO_MODULE_DEMOMENU', 'yes');
define('PRO_MODULE_TRADING_PL', 'yes');
define('PRO_MODULE_CALCULATIONS_REPORT', 'yes');
define('PRO_MODULE_MANUFACTURE_MACHINE_CHAIN', 'yes');
define('PRO_MODULE_MANUFACTURE_CASTING', 'yes');
...
define('DISPLAY_NET_AMOUNT', 0); // '1 means show 0 not show
