...
ALTER TABLE `item_bom` ADD PRIMARY KEY (`item_id`);

ALTER TABLE `item_bom` MODIFY `item_id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;


ALTER TABLE `design_master` ADD `weight_for_bom` DOUBLE NULL AFTER `die_no`;

-- <<Shokohifaramir>> <<Date Time>>

ALTER TABLE `item_bom` ADD `weight_for_bom` DOUBLE NULL AFTER `weight`;

ALTER TABLE `item_bom` CHANGE `item_id` `item_bom_id` INT(11) NOT NULL AUTO_INCREMENT;

ALTER TABLE `item_bom` ADD `item_id` INT NOT NULL AFTER `item_bom_id`;